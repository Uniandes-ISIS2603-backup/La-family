...
/**
 * Pruebas de logica de la relacion Cliente - Books
 *
 * @author ISIS2603
 */
...
public class ClienteBooksLogicTest {
    ...
    @Inject
    private ClienteBooksLogic authorBookLogic;
    ...
    private ClienteEntity author = new ClienteEntity();
    ...
    private void insertData() {
        ...
        author = factory.manufacturePojo(ClienteEntity.class);
        author.setId(1L);
