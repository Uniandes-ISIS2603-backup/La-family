...
insert into BookEntity (id, name, isbn, image, description, publishDate, editorial_id, categoria, esBestseller, precio, novedad) values (400, 'The Winds of Winter', '744706866-7', 'http://www.darkmediaonline.com/wp-content/uploads/2013/01/WindsofWinter.jpg', 'Reposition Left Femoral Shaft, Perc Endo Approach', '10/10/1998',200, 'Adulto', 1, 200, 0);
insert into BookEntity (id, name, isbn, image, description, publishDate, editorial_id, categoria, esBestseller, precio, novedad) values (500, 'The Slow Regard of Silent Things', '260760424-9', 'http://www.patrickrothfuss.com/images/page/cover-slow-regard_277.jpg', 'Supplement Lower Artery with Autol Sub, Perc Approach', '5/9/2013',200, 'Adulto', 0, 200, 1);
insert into BookEntity (id, name, isbn, image, description, publishDate, editorial_id, categoria, esBestseller, precio, novedad) values (600, 'Harry Potter and the Philosopher´s Stone', '260760424-9', 'https://katemacdonalddotnet.files.wordpress.com/2015/11/potter-1-4.jpg', 'disse accumsan tortor quis turp Perc Approach', '5/9/2013',200, 'Juvenil', 0, 500, 0);
insert into BookEntity (id, name, isbn, image, description, publishDate, editorial_id, categoria, esBestseller, precio, novedad) values (700, 'Cazadores de sombras', '2452525255-4', 'https://imagessl9.casadellibro.com/a/l/t5/69/9788408038269.jpg', 'disse accumsan tortor quis turp Perc Approach', '8/10/2010',200, 'Juvenil', 1, 100, 1);
...
insert into BookEntity_AuthorEntity (books_id,authors_id ) values (700,100);      
